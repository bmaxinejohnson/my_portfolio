...
import PlaceholderHero from '../assets/yellow.jpg'
import PlaceholderHero2 from '../assets/crumbled_paper.jpg'

const fullName = 'Brianna Johnson';
const personalQuote = "Eat . Sleep . Code . Repeat.";
const professionalSummary = 'Customer-focused IT Professional with over five years of experience in driving customer satisfaction and retention';
  ...
  return (
    <main className="home-container">
      <section className="home-hero home-subsection">
        ...
        <img className="hero-background" src={PlaceholderHero} alt="chalkboard image" />
      </section>
